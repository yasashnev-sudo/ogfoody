...
"[project]/lib/meals-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useMenu(weekType) {
    ...
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(url, fetcher, {
...
_s(useMenu, "VRI3YSxoWYZ/jyoKeeIu/AvyMKw=", false, function() {
    return [
...
_s1(useWeeklyMenu, "4QYhmC7UvIGcgtIbT5P05/8RGko=", false, function() {
    return [
        useMenu
    ];
});
...
_s2(useFullMenu, "4QYhmC7UvIGcgtIbT5P05/8RGko=", false, function() {
    return [
        useMenu
    ];
});
...
"[project]/hooks/useDebugRecorder.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useDebugRecorder(userId, userEmail) {
    _s();
    const logsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    ...
    const addLog = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[addLog]": (level, message, data)=>{
            const logEntry = {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDebugRecorder.useEffect": ()=>{
            ...
            console.log = ({
                "useDebugRecorder.useEffect": (...args)=>{
                    addLog('log', args.map({
                        "useDebugRecorder.useEffect": (arg)=>typeof arg === 'object' ? JSON.stringify(arg, null, 2) : String(arg)
                    }["useDebugRecorder.useEffect"]).join(' '));
                    originalConsole.log(...args);
                }
            })["useDebugRecorder.useEffect"];
            console.error = ({
                "useDebugRecorder.useEffect": (...args)=>{
                    addLog('error', args.map({
                        "useDebugRecorder.useEffect": (arg)=>typeof arg === 'object' ? JSON.stringify(arg, null, 2) : String(arg)
                    }["useDebugRecorder.useEffect"]).join(' '));
    ...
    const captureScreenshot = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[captureScreenshot]": async ()=>{
            try {
                const canvas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html2canvas$2f$dist$2f$html2canvas$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(document.body, {
                    allowTaint: true,
                    useCORS: true,
                    logging: false,
                    ...
                    ignoreElements: {
                        "useDebugRecorder.useCallback[captureScreenshot]": (element)=>{
                            // Пропускаем элементы, которые могут вызывать проблемы
                            return false;
                        }
                    }["useDebugRecorder.useCallback[captureScreenshot]"],
                    onclone: {
                        "useDebugRecorder.useCallback[captureScreenshot]": (clonedDoc)=>{
                            // Убираем проблемные стили из клона
                            const allElements = clonedDoc.querySelectorAll('*');
                            allElements.forEach({
                                "useDebugRecorder.useCallback[captureScreenshot]": (el)=>{
    ...
    const captureError = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[captureError]": async (options = {})=>{
            if (isCapturing) {
            ...
            try {
                ...
                const recentLogs = logsRef.current.slice(-20).map({
                    "useDebugRecorder.useCallback[captureError].recentLogs": (log)=>`[${log.timestamp}] [${log.level.toUpperCase()}] ${log.message}${log.data ? `\nData: ${JSON.stringify(log.data, null, 2)}` : ''}`
                }["useDebugRecorder.useCallback[captureError].recentLogs"]);
    ...
    }["useDebugRecorder.useCallback[captureError]"], [
        isCapturing,
        addLog,
        captureScreenshot,
        userId,
    ...
    const sendManualReport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[sendManualReport]": async (userComment)=>{
            return captureError({
    ...
    }["useDebugRecorder.useCallback[sendManualReport]"], [
        captureError
    ]);
    // Получить текущие логи
    const getLogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[getLogs]": ()=>{
            return [
                ...logsRef.current
            ];
        }
    ...
    const clearLogs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[clearLogs]": ()=>{
            logsRef.current = [];
    ...
    const log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[log]": (message, data)=>{
            addLog('log', message, data);
        }
    }["useDebugRecorder.useCallback[log]"], [
        addLog
    ]);
    const error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[error]": (message, data)=>{
            addLog('error', message, data);
        }
    }["useDebugRecorder.useCallback[error]"], [
        addLog
    ]);
    const warn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[warn]": (message, data)=>{
            addLog('warn', message, data);
        }
    }["useDebugRecorder.useCallback[warn]"], [
        addLog
    ]);
    const info = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useDebugRecorder.useCallback[info]": (message, data)=>{
            addLog('info', message, data);
        }
    }["useDebugRecorder.useCallback[info]"], [
        addLog
    ]);
    return {
        // Основные методы
...
_s(useDebugRecorder, "r9codX1y0iwh1N31TuRyQwwY4YI=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_81f7662e._.js.map