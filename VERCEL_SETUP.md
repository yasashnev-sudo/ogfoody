...
### ⚠️ ВАЖНО: Переменные должны быть установлены для Production!

Если переменные установлены только для Preview, они **НЕ будут работать** в Production деплое!
...
4. Для **каждой существующей переменной**:
   - Нажмите на три точки (⋯) рядом с переменной
   - Выберите **Edit**
   - В разделе **Environments** выберите **Production** (или **All Environments**)
   - Сохраните изменения
5. Добавьте следующие переменные для **Production окружения** (или All Environments):
